return {
    ...
    keys = {
        -- Core control
        { "<leader>cs", "<cmd>SmoothCursorStart<cr>",             desc = "SmoothCursor: Start" },
        { "<leader>cS", "<cmd>SmoothCursorStop<cr>",              desc = "SmoothCursor: Stop" },
        { "<leader>ck", "<cmd>SmoothCursorStop --keep-signs<cr>", desc = "SmoothCursor: Stop (keep signs)" },
        { "<leader>ct", "<cmd>SmoothCursorToggle<cr>",            desc = "SmoothCursor: Toggle" },

        -- Fancy mode
        { "<leader>cf", "<cmd>SmoothCursorFancyToggle<cr>",       desc = "SmoothCursor: Toggle fancy mode" },
        { "<leader>cF", "<cmd>SmoothCursorFancyOn<cr>",           desc = "SmoothCursor: Fancy mode ON" },
        { "<leader>cO", "<cmd>SmoothCursorFancyOff<cr>",          desc = "SmoothCursor: Fancy mode OFF" },

        -- Status & cleanup
        { "<leader>ci", "<cmd>SmoothCursorStatus<cr>",            desc = "SmoothCursor: Show status" },
        { "<leader>cd", "<cmd>SmoothCursorDeleteSigns<cr>",       desc = "SmoothCursor: Delete signs" },

        -- Jump
        { "<leader>cj", "<cmd>SmoothCursorJump<cr>",              desc = "SmoothCursor: Jump to last position" },
    },
    init = function()
        -- Enable by default
