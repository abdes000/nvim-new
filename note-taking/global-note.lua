return {
    ...
    keys = {
        -- Default/global note
        {
            ...
            desc = "Global Note: Toggle default note"
        },

        -- Project-specific note
        {
            "<leader>gp",
            function() require("global-note").toggle_note("projects") end,
            desc = "Global Note: Toggle projects note"
        },

        -- Food-specific note
        {
            "<leader>gf",
            function() require("global-note").toggle_note("food") end,
            desc = "Global Note: Toggle food note"
        },
