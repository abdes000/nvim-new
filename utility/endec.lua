return {
    ...
    keys = {
        -- Base64
        { "gb",  function() require("decipher").decode_popup("base64") end,    mode = { "n", "v" }, desc = "Decipher: Decode Base64 (popup)" },
        { "gyb", function() require("decipher").decode("base64") end,          mode = { "n", "v" }, desc = "Decipher: Decode Base64 (in-place)" },
        { "gB",  function() require("decipher").encode("base64") end,          mode = { "n", "v" }, desc = "Decipher: Encode Base64 (in-place)" },

        -- Base64URL
        { "gs",  function() require("decipher").decode_popup("base64url") end, mode = { "n", "v" }, desc = "Decipher: Decode Base64URL (popup)" },
        { "gys", function() require("decipher").decode("base64url") end,       mode = { "n", "v" }, desc = "Decipher: Decode Base64URL (in-place)" },
        { "gS",  function() require("decipher").encode("base64url") end,       mode = { "n", "v" }, desc = "Decipher: Encode Base64URL (in-place)" },

        -- URL
        { "gl",  function() require("decipher").decode_popup("url") end,       mode = { "n", "v" }, desc = "Decipher: Decode URL (popup)" },
        { "gyl", function() require("decipher").decode("url") end,             mode = { "n", "v" }, desc = "Decipher: Decode URL (in-place)" },
        { "gL",  function() require("decipher").encode("url") end,             mode = { "n", "v" }, desc = "Decipher: Encode URL (in-place)" },
    },
